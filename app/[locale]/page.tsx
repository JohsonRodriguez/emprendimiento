...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const schema = { "@context": "https://schema.org", "@type": "ProfessionalService", name: "Tueny", url: `https://johsonrodriguez.github.io/emprendimiento/${locale}/`, logo: "https://johsonrodriguez.github.io/emprendimiento/brand/tueny-symbol-master.svg", areaServed: "US", knowsLanguage: ["en", "es"], serviceType: ["Web design", "Website redesign", "Bilingual websites"] };
