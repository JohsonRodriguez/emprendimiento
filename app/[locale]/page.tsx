...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const schema = { "@context": "https://schema.org", "@type": "ProfessionalService", name: "Nueva Web", url: `https://nuevaweb.studio/${locale}`, areaServed: "US", knowsLanguage: ["en", "es"], serviceType: ["Web design", "Website redesign", "Bilingual websites"] };
